...
public class TeleOpDrive extends Command {
  ...
  public void execute() {
    ...
    // Elevator
    //
    elevatorPos += -Controllers.ManipulatorInput.getRightJoyY();
    ...
    if (Controllers.ManipulatorInput.getB()) { // L2
      elevatorPos = Constants.ElevatorConstants.elevatorL2;
    }
    if (Controllers.ManipulatorInput.getY()) { // L3
      elevatorPos = Constants.ElevatorConstants.elevatorL3;
    } 
    if (Controllers.ManipulatorInput.getA()) { // Source
